    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden ring-1 ring-slate-200">
      ...
      <div className="p-4 flex items-center gap-4">
        ...
        <div>
          ...
          <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">{props.obj.text || "Visit me"}</button>
          </div>
      </div>
    </div>
  </div>
